    ...
    <section className="text-white">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <div>
          ...
          <p className="mt-4">
            In addition to web development, I have a strong foundation in Python,
            having created various projects that demonstrate my problem-solving
            skills. I'm also familiar with SQL, which helps me manage and
            interact with databases efficiently.
          </p>
          <p className="mt-4">
            As I continue my journey in tech, I'm excited to learn, grow, and take on
            new challenges!
          </p>
        </div>
        <Image
