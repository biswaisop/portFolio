        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6 relative">
            ...
            <div className="relative pl-8 group">
              ...
              <div className="bg-zinc-800/30 rounded-xl p-5 border border-zinc-700/50 hover:border-purple-500/50 hover:bg-zinc-800/50 transition-all duration-300">
                <div className="flex items-start justify-between mb-2">
                  <h4 className="text-base font-bold text-white">B.Tech in Computer Science</h4>
                  <span className="px-3 py-1 bg-green-500/10 text-green-400 text-xs rounded-full border border-green-500/20">Current</span>
                </div>
                <p className="text-purple-400 text-sm mb-2 font-medium">RV Institute of Technology and Management</p>
            ...
            <div className="relative pl-8 group">
              ...
              <div className="bg-zinc-800/30 rounded-xl p-5 border border-zinc-700/50 hover:border-purple-500/50 hover:bg-zinc-800/50 transition-all duration-300">
                <h4 className="text-base font-bold text-white mb-2">Higher Secondary (12th)</h4>
                <p className="text-purple-400 text-sm mb-2 font-medium">Netaji Subhas Public School</p>
                <div className="flex items-center justify-between">
                  <p className="text-zinc-500 text-xs">2023</p>
                  <span className="px-3 py-1 bg-purple-500/10 text-purple-400 text-xs rounded-full border border-purple-500/20 font-semibold">85%</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-8 group">
              ...
              <div className="bg-zinc-800/30 rounded-xl p-5 border border-zinc-700/50 hover:border-purple-500/50 hover:bg-zinc-800/50 transition-all duration-300">
                <h4 className="text-base font-bold text-white mb-2">Secondary (10th)</h4>
                <p className="text-purple-400 text-sm mb-2 font-medium">Netaji Subhas Public School</p>
                <div className="flex items-center justify-between">
                  <p className="text-zinc-500 text-xs">2021</p>
                  <span className="px-3 py-1 bg-purple-500/10 text-purple-400 text-xs rounded-full border border-purple-500/20 font-semibold">93%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h4 className="text-white font-semibold text-sm">Current Focus</h4>
                  <p className="text-purple-400 text-xs">Student Developer</p>
                </div>
              </div>
              <p className="text-zinc-300 text-sm leading-relaxed">
                Balancing academics with hands-on coding. Building real-world projects to master web development.
              </p>
            </div>
            ...
            <div className="bg-zinc-800/40 rounded-xl p-6 border border-zinc-700/50 hover:border-purple-500/40 transition-all duration-300 group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h4 className="text-white font-semibold text-sm">Learning Path</h4>
                  <p className="text-purple-400 text-xs">Tech Stack</p>
                </div>
              </div>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-purple-500/10 text-purple-400 text-xs rounded-full border border-purple-500/20">MERN Stack</span>
                <span className="px-3 py-1 bg-blue-500/10 text-blue-400 text-xs rounded-full border border-blue-500/20">Data Science</span>
                <span className="px-3 py-1 bg-pink-500/10 text-pink-400 text-xs rounded-full border border-pink-500/20">Mobile Dev</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-zinc-800/40 rounded-xl p-6 border border-zinc-700/50 hover:border-purple-500/40 transition-all duration-300">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-xs">Recent work & contributions</p>
              </div>
            </div>
            
            <div className="space-y-3">
              {[
                { name: "Portfolio Website", desc: "Modern design with React & Tailwind", icon: "🎨" },
                { name: "Spotify Clone", desc: "Music streaming with playback features", icon: "🎵" },
                { name: "Todo List App", desc: "React-based task management", icon: "✅" }
              ].map((project, index) => (
                <div 
                  key={index}
                ...
                >
                  ...
                  <div className="flex-1">
                    <h5 className="text-white text-sm font-medium mb-0.5">{project.name}</h5>
                    <p className="text-zinc-400 text-xs">{project.desc}</p>
                  </div>
                  <svg className="w-4 h-4 text-zinc-600 group-hover:text-purple-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-gradient-to-br from-zinc-900/90 to-zinc-900/50 backdrop-blur-sm rounded-2xl p-8 border border-zinc-800/50 hover:border-purple-500/30 transition-all duration-500 shadow-xl">
              ...
              <div className="space-y-4 text-zinc-300 text-sm leading-relaxed">
                <p>
                  I&apos;m a <span className="text-purple-400 font-semibold">Computer Science Engineering</span> student at RVITM, 
                  passionate about building elegant web solutions that make a difference.
                </p>
                <p>
                  Specializing in <span className="text-purple-400 font-semibold">Backend development</span>, I create 
                  responsive and dynamic web applications with a focus on user experience and clean code.
                </p>
                <p>
                  Beyond web development, I&apos;m exploring <span className="text-purple-400 font-semibold">Data Science, AI,ML and RAG systems</span> and 
              ...
              <div className="grid grid-cols-3 gap-4 mt-8 pt-6 border-t border-zinc-800">
                <div className="text-center">
                  <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">3+</div>
                  <div className="text-xs text-zinc-500 mt-1">Projects</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">8+</div>
                  <div className="text-xs text-zinc-500 mt-1">Skills</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">2nd</div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-5 border border-zinc-800/50 hover:border-purple-500/30 transition-all duration-300 group">
                <div className="text-3xl mb-3 group-hover:scale-110 transition-transform">🎯</div>
                <div className="text-sm font-semibold text-white mb-1">Focus</div>
                <div className="text-xs text-zinc-400">Full Stack Dev</div>
              </div>
              <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-5 border border-zinc-800/50 hover:border-purple-500/30 transition-all duration-300 group">
                <div className="text-3xl mb-3 group-hover:scale-110 transition-transform">🚀</div>
                <div className="text-sm font-semibold text-white mb-1">Status</div>
                <div className="text-xs text-zinc-400">Open to Work</div>
              </div>
            </div>
          </div>
